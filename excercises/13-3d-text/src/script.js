...
fontLoader.load("/fonts/droid_serif_regular.typeface.json", (font) => {
  ...
  const doughnutGeo = new THREE.TorusGeometry(0.3, 0.2, 20, 45);
//   const doughnutMat = new THREE.MeshMatcapMaterial({ matcap: matcapTexture });
  
  for (let i = 0; i < 250; i++) {
    const doughnut = new THREE.Mesh(doughnutGeo, material);
